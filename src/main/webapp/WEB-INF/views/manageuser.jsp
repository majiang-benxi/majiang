...
var changeItemPage = function(curPageP){
	...
	if(searchUname==null || searchUname=='' || searchUname=='undefined'){
	 ...
	 $.ajax({
			type: "get",
			url : "/mvc/user/getAdminUserList?datemin="+datemin+"&datemax="+datemax+"&searchUname="+searchUname+"&eachPageCount="+eachPageCount+"&curPage="+curPage+"&t="+new Date().getTime(),
			dataType:'html',
			data: '', 
			async:true,
...
function datadel(){
	...
	$.ajax({
	    url:'/mvc/user/updateAdminUserSate',
	    type:'POST', //GET
